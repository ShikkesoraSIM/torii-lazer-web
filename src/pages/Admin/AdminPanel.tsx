          ...
          <div className="lg:w-60 w-full flex-shrink-0">
            <div className="bg-card/95 md:main-card-shadow md:rounded-2xl md:border md:border-card backdrop-blur-sm overflow-visible">
              ...
              <nav className="bg-transparent md:bg-card px-3 md:px-5 py-3 md:py-4 space-y-1.5">
                ...
                >
                  <div className="flex items-center gap-3">
                    {/* Filled-heart glyph mirrors the supporter heart in the
                        public navbar so the affordance reads as "donations"
                        without a label change. */}
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 21s-7.5-4.6-9.5-9.6C1.4 8.5 3.6 5 7 5c2 0 3.7 1 5 2.7C13.3 6 15 5 17 5c3.4 0 5.6 3.5 4.5 6.4C19.5 16.4 12 21 12 21z"/>
                    </svg>
                    <span>Donations</span>
                  </div>
                </button>
