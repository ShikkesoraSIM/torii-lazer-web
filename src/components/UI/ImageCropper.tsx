...
const ImageCropper: React.FC<ImageCropperProps> = ({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[1200] bg-black/75 backdrop-blur-sm p-3 sm:p-4 overflow-y-auto"
      style={{ zIndex: 1000002 }}
    >
      <div className="mx-auto my-auto glass-thick rounded-xl max-w-5xl w-full max-h-[calc(100vh-1.5rem)] sm:max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
